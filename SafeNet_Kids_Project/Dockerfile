...
# System deps for bcrypt / Pillow / OpenCV
RUN apt-get update && apt-get install -y --no-install-recommends \
    build-essential gcc python3-dev libffi-dev libssl-dev libgl1-mesa-glx libglib2.0-0 && \
